...
all.modeled.data<-read.csv("all.modeled.data.csv")
...
WS08_augsep <- read.csv("WS08_dailies_31Aug-29Sep_2018.csv")
...
#Here's the csv :)
write.csv(all_daily_temps_SIYR1, "landscape_dailytemp_masterlong_SIyr1.csv")
