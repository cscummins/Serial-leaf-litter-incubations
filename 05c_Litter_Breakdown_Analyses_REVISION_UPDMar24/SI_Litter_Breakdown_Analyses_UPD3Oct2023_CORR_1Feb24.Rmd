...
all_si_yr1yr2_lb_pc <- read.csv("all_si_lb_phys_chem_yr1_yr2_1Feb24.csv")
...
#coarse
all_si_yr1yr2_lb_pc.coarse <- all_si_yr1yr2_lb_pc %>% select(date_dep, date_coll, deployment, deployment2,
                                                             days_in_record, stream, rhodo_acer,
...
#fine
all_si_yr1yr2_lb_pc.fine <- all_si_yr1yr2_lb_pc %>% select(date_dep, date_coll, deployment, deployment2, days_in_record,
                                                           stream, rhodo_acer, mean_k_fine, sd_k_fine, se_k_fine, ci_k_fine,
...
all_si_yr1yr2_lb_pc.shred <- all_si_yr1yr2_lb_pc %>% select(date_dep, date_coll, deployment, deployment2, days_in_record,
...
#shredders - Lecerf
all_si_yr1yr2_lb_pc.shred_new <- all_si_yr1yr2_lb_pc %>%  select(date_dep, date_coll, deployment, deployment2, days_in_record,
