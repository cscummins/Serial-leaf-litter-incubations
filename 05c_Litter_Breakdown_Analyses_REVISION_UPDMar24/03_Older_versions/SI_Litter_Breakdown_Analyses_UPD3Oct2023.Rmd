...
all_si_yr1yr2_lb_pc <- read.csv("all_si_lb_phys_chem_yr1_yr2_3Oct2023.csv")
...
Rsh.k12 <- k_val_fun(lnk0=-6.75632, tempcel=12, one.k.t0=40.64, Ea=-1.5)
...
Ash.k12 <- k_val_fun(lnk0=-5.29732, tempcel=12, one.k.t0=40.64, Ea=-0.98)
...
k12k16.plot <- ggplot(k.inc.df.12.16)+ 
  ...
  annotate("text", x=1.0, y=0.0065, label= "+ 0.0035", size=5.5)+
...
absinc.det.A.12.16 <- Ash.k16-Ash.k12 #0.0035
...
Rcoarse.k12 <- k_val_fun(lnk0=-5.11962, tempcel=12, one.k.t0 = 40.69, Ea=-0.90)
Acoarse.k12 <- k_val_fun(lnk0=-3.77282, tempcel=12, one.k.t0 = 40.71, Ea=-0.53)

Rcoarse.k16 <- k_val_fun(lnk0=-5.11962, tempcel=16, one.k.t0 = 40.69, Ea=-0.90)
Acoarse.k16 <- k_val_fun(lnk0=-3.77282, tempcel=16, one.k.t0 = 40.71, Ea=-0.53)
