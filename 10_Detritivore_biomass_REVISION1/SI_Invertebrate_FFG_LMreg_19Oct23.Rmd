...
Reorder dates so they appear in the right order on the graph
```{r}
...
Graph of average shredder abundance per month
```{r}
pal <- c("#009292", "#ff6db6","#b6dbff","#924900")

plot_shredder_abundance <- ggplot(data=shredders_per_sample_avg_by.month) + 
  geom_bar(aes(x=sample.month, y=average_shredders, fill = sample.month), stat="identity")+
  geom_errorbar(aes(x=sample.month, ymin=lcl, ymax= ucl), width = 0.4, color ="black", linewidth = 1)+
  theme_classic()+
  labs(x= "Sample month", y = "Mean shredder abundance \n per leaf pack")+
  scale_fill_manual(values = pal,labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)", "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
        labels=c(expression(atop(paste("11 Dec 17"),"(Oct-Dec)")), expression(atop(paste("5 Jan 18"),"(Nov-Jan)")), expression(atop(paste("5 Jul 18"),"(May-Jul)")), expression(atop(paste("31 Aug 18"),"(Jul-Sep)"))))+theme(axis.title.x=element_blank())+
  theme(axis.title.y = element_text(size=14))+
  theme(axis.text.y=element_text(size=14))+
  theme(legend.title=element_blank())+
  theme(legend.text=element_text(size=12))+
  labs(tag="(a)")+
  theme(plot.tag = element_text(size=20),plot.tag.position = c(0.23, 0.93))#+theme(axis.text.x=element_blank())

#plot_shredder_abundance
...
Graph the data for total invert abundance
```{r}

plot_invert_abundance <- ggplot(data=inverts_per_sample_avg_by.month) + 
  geom_bar(aes(x=sample.month, y=average_inverts, fill = sample.month), stat="identity")+
  geom_errorbar(aes(x=sample.month, ymin=lci, ymax= uci), width = 0.4, color ="black", linewidth = 1)+
  theme_classic()+
  labs(x= "Sample month", y = "Mean invertebrate abundance \n per leaf pack")+
  scale_fill_manual(values = pal,labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)", "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+theme(axis.title.x=element_blank())+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
        labels=c(expression(atop(paste("11 Dec 17"),"(Oct-Dec)")), expression(atop(paste("5 Jan 18"),"(Nov-Jan)")), expression(atop(paste("5 Jul 18"),"(May-Jul)")), expression(atop(paste("31 Aug 18"),"(Jul-Sep)"))))+theme(axis.title.x=element_blank())+theme(axis.title.x=element_blank())+
  theme(axis.title.y = element_text(size=14))+
  theme(axis.text.y=element_text(size=14))+
  theme(legend.title=element_blank())+
  theme(legend.text=element_text(size=12))+
...
Plot shredder biomass per month
```{r}

plot_shredder_biomass <- ggplot(data=shredder_bm_per_sample_avg_by.month) + 
  geom_bar(aes(x=sample.month, y=average_shredder_bm, fill = sample.month), stat="identity")+
  geom_errorbar(aes(x=sample.month, ymin=lci, ymax= uci), width = 0.4, color ="black", linewidth = 1)+
  theme_classic()+
  labs(x= "Sample month", y = "Mean shredder biomass (mg) \n per leaf pack")+
  scale_fill_manual(values = pal,labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)", "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
        labels=c(expression(atop(paste("11 Dec 17"),"(Oct-Dec)")), expression(atop(paste("5 Jan 18"),"(Nov-Jan)")), expression(atop(paste("5 Jul 18"),"(May-Jul)")), expression(atop(paste("31 Aug 18"),"(Jul-Sep)"))))+theme(axis.title.x=element_blank())+
  ...
  theme(legend.text=element_text(size=12))+
  labs(tag="(b)")+
  theme(plot.tag = element_text(size=20),plot.tag.position = c(0.21, 0.93)) #+ theme(axis.text.x = element_blank())

#plot_shredder_biomass
...
Plot total invertebrate biomass
```{r}

plot_invert_biomass <- ggplot(data=invert_bm_per_sample_avg_by.month) + 
  geom_bar(aes(x=sample.month, y=average_invert_bm, fill = sample.month), stat="identity")+
  geom_errorbar(aes(x=sample.month, ymin=lci, ymax= uci), width = 0.4, color ="black", linewidth = 1)+
  theme_classic()+
  labs(x= "Sample month", y = "Mean invertebrate biomass (mg) \n per leaf pack")+
...
Join these dfs back with stream, too
```{r}
...
plot - shredder abundance per g AFDM
```{r}

plot_shredders_per_gAFDM <- ggplot(data=shredders_per_gAFDM_avg_by.month) + 
  geom_bar(aes(x=sample.month, y=average_shredders_per_gAFDM, fill = sample.month), stat="identity")+
  geom_errorbar(aes(x=sample.month, ymin=lci, ymax= uci), width = 0.4, color ="black", linewidth = 1)+
  theme_classic()+
  labs(x= "Sample month", y = expression(atop(paste("Mean shredder abundance"), "g AFDM"^-1*"")))+
  scale_fill_manual(values = pal,labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)",
                                          "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
  ...
  theme(legend.title=element_blank())+
  theme(legend.text=element_text(size=12))+
  labs(tag="(a)")+theme(plot.tag = element_text(size=20),plot.tag.position = c(0.24, 0.93))#+theme(axis.text.x = element_blank())


#plot_shredders_per_gAFDM
...
plot - shredder biomass per g AFDM
```{r}

plot_shredder_bm_per_gAFDM <- ggplot(data=shredder_bm_per_gAFDM_avg_by.month) + 
  geom_bar(aes(x=sample.month, y=average_shredder_bm_per_gAFDM, fill = sample.month), stat="identity")+
  geom_errorbar(aes(x=sample.month, ymin=lci, ymax= uci), width = 0.4, color ="black", linewidth = 1)+
  theme_classic()+
  labs(x= "Sample month", y = expression(atop(paste("Mean shredder biomass (mg)"), "g AFDM"^-1*"")))+
  scale_fill_manual(values = pal, labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)",
                                          "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
  ...
  theme(legend.title=element_blank())+
  theme(legend.text=element_text(size=12))+
  labs(tag="(b)")+theme(plot.tag = element_text(size=20),plot.tag.position = c(0.21, 0.93))#+theme(axis.text.x = element_blank())

#plot_shredder_bm_per_gAFDM
...
plot - invertebrate abundance per g AFDM
```{r}

plot_inverts_per_gAFDM <- ggplot(data=inverts_per_gAFDM_avg_by.month) + 
  geom_bar(aes(x=sample.month, y=average_inverts_per_gAFDM, fill = sample.month), stat="identity")+
  geom_errorbar(aes(x=sample.month, ymin=lci, ymax= uci), width = 0.4, color ="black", linewidth = 1)+
  theme_classic()+
  labs(x= "Sample month", y = expression(atop(paste("Mean invertebrate abundance"), "g AFDM"^-1*"")))+
  scale_fill_manual(values = pal,labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)",
                                          "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
  ...
  theme(legend.title=element_blank())+
  theme(legend.text=element_text(size=12))+
  labs(tag="(c)")+theme(plot.tag = element_text(size=20),plot.tag.position = c(0.24, 0.93))

#plot_inverts_per_gAFDM
...
plot - invert biomass per g AFDM
```{r}

plot_invert_bm_per_gAFDM <- ggplot(data=invert_bm_per_gAFDM_avg_by.month) + 
  geom_bar(aes(x=sample.month, y=average_invert_bm_per_gAFDM, fill = sample.month), stat="identity")+
  geom_errorbar(aes(x=sample.month, ymin=lci, ymax= uci), width = 0.4, color ="black", linewidth = 1)+
  theme_classic()+
  labs(x= "Sample month", y = expression(atop(paste("Mean invertebrate biomass (mg)"), "g AFDM"^-1*"")))+
  scale_fill_manual(values = pal, labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)",
                                          "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
...
plot - log invert biomass per g AFDM
```{r}

plot_log_invert_bm_per_gAFDM <- ggplot(data=log_invert_bm_per_gAFDM_avg_by.month) + 
  geom_bar(aes(x=sample.month, y=average_log_invert_bm_per_gAFDM, fill = sample.month), stat="identity")+
  geom_errorbar(aes(x=sample.month, ymin=lci, ymax= uci), width = 0.4, color ="black", linewidth = 1)+
  theme_classic()+
  labs(x= "Sample month", y = expression(paste("log"["e"],"(mean invertebrate biomass (mg) / g AFDM)")))+
  scale_fill_manual(values = pal, labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)",
                                          "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
...
#plot_log_invert_bm_per_gAFDM

```

LMER models with a random effect for stream

shredder biomass per g afdm ~ sample.month
```{r}

shredder_bm_per_sample_LL$sample.month <- as.factor(shredder_bm_per_sample_LL$sample.month)

lmer_shredder_biomass <- lmer(shredder_bm_per_g_afdm~sample.month + (1|stream), data=shredder_bm_per_sample_LL)
summary(lmer_shredder_biomass)

#4 different ways of doing multiple comparisons -- which is most appropriate?
emmeans(lmer_shredder_biomass, list(pairwise ~ sample.month))
lsmeans(lmer_shredder_biomass, list(pairwise~sample.month))#appears to be the same as emmeans
summary(glht(lmer_shredder_biomass,lsm(pairwise~sample.month)))
summary(glht(lmer_shredder_biomass, linfct=mcp(sample.month = "Tukey")))
#all multcomp methods agree for this model in terms of which pairwise differences are significant

#Histogram of residuals
resid.sh.bm <- residuals(lmer_shredder_biomass)

```

shredder abundance per g AFDM ~ sample month
```{r}

shredders_per_sample_LL$sample.month <- as.factor(shredders_per_sample_LL$sample.month)

lmer_shredder_abundance <- lmer(shredders_per_g_afdm~sample.month + (1|stream), data=shredders_per_sample_LL)
summary(lmer_shredder_abundance)

#4 different ways of doing multiple comparisons -- which is most appropriate?
emmeans(lmer_shredder_abundance, list(pairwise ~ sample.month))
#lsmeans(lmer_shredder_abundance, list(pairwise~sample.month))#appears to be the same as emmeans
#summary(glht(lmer_shredder_abundance, lsm(pairwise~sample.month)))
#summary(glht(lmer_shredder_abundance, linfct=mcp(sample.month = "Tukey")))
#all multcomp methods agree for this model in terms of which pairwise differences are significant

#histogram of model residuals
resid.sh.abund <- residuals(lmer_shredder_abundance)

```


invert biomass per g AFDM ~ sample month
```{r}

total.biomass.per.sample_LL$sample.month <- as.factor(total.biomass.per.sample_LL$sample.month)
lmer_invert_biomass <- lmer(invert_bm_per_g_afdm~sample.month + (1|stream), data=total.biomass.per.sample_LL)
summary(lmer_invert_biomass)

emmeans(lmer_invert_biomass, list(pairwise ~ sample.month))
...
#histogram of model residuals
resid.inv.biomass <- residuals(lmer_invert_biomass)

```

LMER invert abundance
```{r}

total.abundance.per.sample_LL$sample.month <- as.factor(total.abundance.per.sample_LL$sample.month)

lmer_invert_abundance <- lmer(inverts_per_g_afdm~sample.month + (1|stream), data=total.abundance.per.sample_LL)
summary(lmer_invert_abundance)

emmeans(lmer_invert_abundance, list(pairwise ~ sample.month))
...
#histogram of model residuals
resid.inv.abund <- residuals(lmer_invert_abundance)

```

LMER log invert biomass
```{r}

lmer_ln_invert_biomass <- lmer(ln_invert_biomass_AFDM~sample.month + (1|stream), data=total.biomass.per.sample_LL)
summary(lmer_ln_invert_biomass)
...
#histogram of model residuals
resid.ln.inv.biomass <- residuals(lmer_invert_abundance)
...
shredder bm per leaf pack ~ sample.month
```{r}

shredder_bm_per_sample$sample.month <- as.factor(shredder_bm_per_sample$sample.month)
lmer_shredder_biomass_uncorr <- lmer(shredder_biomass~sample.month + (1|stream), data=shredder_bm_per_sample)
summary(lmer_shredder_biomass_uncorr)

emmeans(lmer_shredder_biomass_uncorr, list(pairwise ~ sample.month))
#lsmeans(lmer_shredder_biomass_uncorr, list(pairwise~sample.month))#appears to be the same as emmeans
#summary(glht(lmer_shredder_biomass_uncorr, lsm(pairwise~sample.month)))
#summary(glht(lmer_shredder_biomass_uncorr, linfct=mcp(sample.month = "Tukey")))
#all multcomp methods agree for this model in terms of which pairwise differences are significant

#histogram of model residuals
resid.sh.biomass.uncorr <- residuals(lmer_shredder_biomass_uncorr)

```


shredder abundance ~ sample.month
```{r}

shredders_per_sample$sample.month <- as.factor(shredders_per_sample$sample.month)
lmer_shredder_abundance_uncorr <- lmer(number_of_shredders~sample.month + (1|stream), data=shredders_per_sample)
summary(lmer_shredder_abundance_uncorr)

emmeans(lmer_shredder_abundance_uncorr, list(pairwise ~ sample.month))
#lsmeans(lmer_shredder_abundance_uncorr, list(pairwise~sample.month))#appears to be the same as emmeans
#summary(glht(lmer_shredder_abundance_uncorr, lsm(pairwise~sample.month)))
#summary(glht(lmer_shredder_abundance_uncorr, linfct=mcp(sample.month = "Tukey")))
#all multcomp methods agree for this model in terms of which pairwise differences are significant

#histogram of model residuals
resid.sh.abund.uncorr <- residuals(lmer_shredder_abundance_uncorr)

```


total abundance per leaf pack ~ sample.month
```{r}

total.abundance.per.sample$sample.month <- as.factor(total.abundance.per.sample$sample.month)
lmer_invert_abundance_uncorr <- lmer(total_inverts~sample.month + (1|stream), data=total.abundance.per.sample)
summary(lmer_invert_abundance_uncorr)

emmeans(lmer_invert_abundance_uncorr, list(pairwise ~ sample.month))
#lsmeans(lmer_invert_abundance_uncorr, list(pairwise~sample.month))#appears to be the same as emmeans
#summary(glht(lmer_invert_abundance_uncorr, lsm(pairwise~sample.month)))
#summary(glht(lmer_invert_abundance_uncorr, linfct=mcp(sample.month = "Tukey")))
#all multcomp methods agree for this model in terms of which pairwise differences are significant

#histogram of model residuals
resid.inv.abund.uncorr <- residuals(lmer_invert_abundance_uncorr)
...
lmer_invert_biomass_uncorr <- lmer(total_invert_biomass~sample.month + (1|stream), data=total.biomass.per.sample_LL)
summary(lmer_invert_biomass_uncorr)

emmeans(lmer_invert_biomass_uncorr, list(pairwise ~ sample.month))
#lsmeans(lmer_invert_biomass_uncorr, list(pairwise~sample.month))#appears to be the same as emmeans
#summary(glht(lmer_invert_biomass_uncorr, lsm(pairwise~sample.month)))
#summary(glht(lmer_invert_biomass_uncorr, linfct=mcp(sample.month = "Tukey")))
#all multcomp methods agree for this model in terms of which pairwise differences are significant

#histogram of model residuals
resid.inv.bm.uncorr <- residuals(lmer_invert_biomass_uncorr)
...
Try adding a small value to the shredders per g AFDM data, then log, then graph and model

add 0.1 and log - model - shredder abundance
```{r}

shredders_per_sample_LL <- shredders_per_sample_LL %>% mutate(shredders_per_g_afdm_plus0.1 = shredders_per_g_afdm+0.1)
shredders_per_sample_LL <- shredders_per_sample_LL %>% mutate(ln_shredders_per_g_afdm_plus0.1=log(shredders_per_g_afdm_plus0.1))

lmer_shredder_abundance_log_0.1 <- lmer(ln_shredders_per_g_afdm_plus0.1~sample.month + (1|stream), data=shredders_per_sample_LL)
summary(lmer_shredder_abundance_log_0.1)

emmeans(lmer_shredder_abundance_log_0.1, list(pairwise ~ sample.month))
#lsmeans(lmer_shredder_abundance_log_0.1, list(pairwise~sample.month))#appears to be the same as emmeans
#summary(glht(lmer_shredder_abundance_log_0.1, lsm(pairwise~sample.month)))
#summary(glht(lmer_shredder_abundance_log_0.1, linfct=mcp(sample.month = "Tukey")))
#all multcomp methods agree for this model in terms of which pairwise differences are significant

#histogram of model residuals
resid.ln.abund.perg.0.1 <- residuals(lmer_shredder_abundance_log_0.1)

```


add 1 and log - model - shredder abundance
```{r}

shredders_per_sample_LL <- shredders_per_sample_LL %>% mutate(shredders_per_g_afdm_plus1 = shredders_per_g_afdm+1)
shredders_per_sample_LL <- shredders_per_sample_LL %>% mutate(ln_shredders_per_g_afdm_plus1=log(shredders_per_g_afdm_plus1))

lmer_shredder_abundance_log_1 <- lmer(ln_shredders_per_g_afdm_plus1~sample.month + (1|stream), data=shredders_per_sample_LL)
summary(lmer_shredder_abundance_log_1)

emmeans(lmer_shredder_abundance_log_1, list(pairwise ~ sample.month))
#lsmeans(lmer_shredder_abundance_log_1, list(pairwise~sample.month))#appears to be the same as emmeans
#summary(glht(lmer_shredder_abundance_log_1, lsm(pairwise~sample.month)))
#summary(glht(lmer_shredder_abundance_log_1, linfct=mcp(sample.month = "Tukey")))
#all multcomp methods agree for this model in terms of which pairwise differences are significant

#histogram of model residuals
resid.ln.abund.perg.1 <- residuals(lmer_shredder_abundance_log_1)

```

Boxplot - log (shredder abundance per g AFDM + 1)
```{r}
...
boxplot.sh.abund.pergAFDM <- ggplot(shredders_per_sample_LL, aes(x=sample.month, y=ln_shredders_per_g_afdm_plus1, fill=sample.month))+
  geom_boxplot()+
  geom_jitter(shape=16, position = position_jitter(0.2))+
  theme_classic()+
  labs(x= "Sample month", y = expression(paste("log"["e"],"(shredder abundance (mg) / g AFDM)")))+
  scale_fill_manual(values = pal, labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)",
                                          "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
...
boxplot.sh.abund.pergAFDM

```


Boxplot - log (shredder biomass per g AFDM + 1)
```{r}
...
boxplot.sh.bm.pergAFDM <- ggplot(shredder_bm_per_sample_LL, aes(x=sample.month, y=ln_shredder_bm_per_g_afdm_plus1, fill=sample.month))+
  geom_boxplot()+
  geom_jitter(shape=16, position = position_jitter(0.2))+
  theme_classic()+
  labs(x= "Sample month", y = expression(paste("log"["e"],"(shredder biomass (mg) / g AFDM)")))+
  scale_fill_manual(values = pal, labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)",
                                          "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
...
boxplot.sh.abund.perlp <- ggplot(shredders_per_sample, aes(x=sample.month, y=number_of_shredders, fill=sample.month))+
  ...
  geom_jitter(shape=16, position = position_jitter(0.2))+
  theme_classic()+
  labs(x= "Sample month", y = expression(paste("Shredder abundance per leaf pack")))+
  scale_fill_manual(values = pal, labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)",
                                          "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
...
boxplot.sh.bm.perlp <- ggplot(shredder_bm_per_sample, aes(x=sample.month, y=shredder_biomass, fill=sample.month))+
  ...
  geom_jitter(shape=16, position = position_jitter(0.2))+
  theme_classic()+
  labs(x= "Sample month", y = expression(paste("Shredder biomass per leaf pack")))+
  scale_fill_manual(values = pal, labels=c("11 Dec 17 (Oct-Dec)", "5 Jan 18 (Nov-Jan)",
                                          "5 Jul 18 (May-Jul)", "31 Aug 18 (Jul-Sep)"))+
  theme(axis.text.x = element_text(face="bold",size=14))+ 
  scale_x_discrete(breaks=c("12","01","07", "08"),
...
##########
Instead of adding random values, add the smallest value in the dataset to both shredders per g afdm and shredder bm per g afdm
```{r}
...
lmer_shredder_abundance_log_0.24 <- lmer(ln_shredders_per_g_afdm_plus0.24~sample.month + (1|stream), data=shredders_per_sample_LL)
...
lmer_shredder_biomass_log_0.018 <- lmer(ln_shredder_bm_per_g_afdm_plus0.018~sample.month + (1|stream), data=shredder_bm_per_sample_LL)
...
boxplot.sh.abund.pergAFDM.0.24 <- ggplot(shredders_per_sample_LL, aes(x=sample.month, y=ln_shredders_per_g_afdm_plus0.24, fill=sample.month))+
  geom_boxplot()+
  geom_jitter(shape=16, position = position_jitter(0.2))+
  theme_classic()+
  labs(x= "Sample month", y = expression(paste("log"["e"],"(shredder abundance (mg) / g AFDM)")))+
...
boxplot.sh.bm.pergAFDM.0.018 <- ggplot(shredder_bm_per_sample_LL, aes(x=sample.month, y=ln_shredder_bm_per_g_afdm_plus0.018, fill=sample.month))+
  geom_boxplot()+
  geom_jitter(shape=16, position = position_jitter(0.2))+
  theme_classic()+
  labs(x= "Sample month", y = expression(paste("log"["e"],"(shredder biomass (mg) / g AFDM)")))+
...
This chunk: NOT corrected per g AFDM
```{r}

non_corr_4panel <- plot_shredder_abundance + plot_shredder_biomass + plot_invert_abundance + plot_invert_biomass + plot_layout(guides="collect", widths=unit(c(10.5),c("cm")), heights=unit(c(8), c("cm")))
non_corr_4panel
...
corr_4panel <- plot_shredders_per_gAFDM + plot_shredder_bm_per_gAFDM + plot_inverts_per_gAFDM + plot_invert_bm_per_gAFDM + plot_layout(guides="collect", widths=unit(c(10.5),c("cm")), heights=unit(c(8), c("cm")))
corr_4panel
