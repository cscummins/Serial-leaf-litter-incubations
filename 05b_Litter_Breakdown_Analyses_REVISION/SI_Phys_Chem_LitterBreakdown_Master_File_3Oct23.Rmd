...
write.csv(all_si_yr1_lb_phys_chem, "all_si_yr1_lb_phys_chem_3Oct2023.csv")
write.csv(all_si_yr2_lb_phys_chem, "all_si_yr2_lb_phys_chem_3Oct2023.csv")
```
...
write.csv(all_si_lb_phys_chem_yr1_yr2, "all_si_lb_phys_chem_yr1_yr2_3Oct2023.csv")
```
