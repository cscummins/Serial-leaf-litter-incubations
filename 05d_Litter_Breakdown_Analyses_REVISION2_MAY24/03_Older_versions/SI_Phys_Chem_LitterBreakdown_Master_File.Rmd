...
#litter breakdown
lb_si_yr1 <- read.csv("litter_breakdown_coarse_fine_yr1_all.4Mar23.csv")
...
#temp
dep_temp_si_yr1 <-read.csv("landscape_deployment_temp_masterlong_SIyr1.csv")
...
write.csv(all_si_yr1_lb_phys_chem, "all_si_yr1_lb_phys_chem_4Mar23.csv")
write.csv(all_si_yr2_lb_phys_chem, "all_si_yr2_lb_phys_chem_4Mar23.csv")
```
...
write.csv(all_si_lb_phys_chem_yr1_yr2, "all_si_lb_phys_chem_yr1_yr2_4Mar23.csv")
```
