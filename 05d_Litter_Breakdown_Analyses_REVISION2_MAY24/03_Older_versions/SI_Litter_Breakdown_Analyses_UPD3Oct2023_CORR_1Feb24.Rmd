...
#Pine watersheds (YR1 = WS01; YR2 = WS17) -- 2016 -> 1832
...
*THIS CODE WAS UPDATED 5 Feb 2024*
```{r}

summary(acer_coarse_model)
acer_coarse_SD <- 0.08472*(sqrt(209))

#what is the probability that Ea falls between 0.6 and 0.7 given the mean Ea (from the model) and the standard deviation?
pnorm(0.7, mean=0.52140, sd=acer_coarse_SD, lower.tail=TRUE) - pnorm(0.6, mean=0.52140, sd=acer_coarse_SD, lower.tail=TRUE)
#0.03238454

##

summary(rhodo_coarse_model)
rhodo_coarse_SD <- 0.09369*(sqrt(214))
pnorm(0.7, mean=0.89452, sd=rhodo_coarse_SD, lower.tail=TRUE) - pnorm(0.6, mean=0.89452, sd=rhodo_coarse_SD, lower.tail=TRUE)
#0.02864211

##

summary(acer_shredder_model)
acer_shred_SD <- 0.23559*(sqrt(184))
pnorm(0.7, mean=0.97222, sd=acer_shred_SD, lower.tail=TRUE) - pnorm(0.6, mean=0.97222, sd=acer_shred_SD, lower.tail=TRUE)
#0.01241993

##

summary(rhodo_shredder_model)
rhodo_shred_SD <- 0.22145*(sqrt(185))
pnorm(0.7, mean=1.49446, sd=rhodo_shred_SD, lower.tail=TRUE) - pnorm(0.6, mean=1.49446, sd=rhodo_shred_SD, lower.tail=TRUE)
#0.01273391

##

summary(acer_microbes_model)
acer_mic_SD <- 0.03796*(sqrt(217))
pnorm(0.7, mean=0.28585, sd=acer_mic_SD, lower.tail=TRUE) - pnorm(0.6, mean=0.28585, sd=acer_mic_SD, lower.tail=TRUE)
#0.05766772

##

summary(rhodo_microbes_model)
rhodo_mic_SD <- 0.05431*(sqrt(217))
pnorm(0.7, mean=0.55549, sd=rhodo_mic_SD, lower.tail=TRUE) - pnorm(0.6, mean=0.55549, sd=rhodo_mic_SD, lower.tail=TRUE)
#0.04948703
...
#Rhodo detritivores
summary(rhodo_shredder_model)
pnorm(0.7, mean=1.49, sd=0.22, lower.tail=TRUE)  - pnorm(0.6, mean=1.5, sd=0.22, lower.tail=TRUE)
#0.000143279
...
Rsh.k10 <- k_val_fun(lnk0=-6.75632, tempcel=10, one.k.t0=40.64, Ea=-1.49)
Rsh.k12 <- k_val_fun(lnk0=-6.75632, tempcel=12, one.k.t0=40.64, Ea=-1.49)
Rsh.k14 <- k_val_fun(lnk0=-6.75632, tempcel=14, one.k.t0=40.64, Ea=-1.49)
Rsh.k16 <- k_val_fun(lnk0=-6.75632, tempcel=16, one.k.t0=40.64, Ea=-1.49)
