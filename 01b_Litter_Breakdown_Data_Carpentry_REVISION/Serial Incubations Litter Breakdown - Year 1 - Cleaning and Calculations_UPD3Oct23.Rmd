...
coarse_fine_data_yr1_all$k_coarse<-as.character(((coarse_fine_data_yr1_all$ln_percent_afdm_start)-(coarse_fine_data_yr1_all$ln_percent_afdm_rem_C))/(0-coarse_fine_data_yr1_all$days_in_record))

coarse_fine_data_yr1_all$k_coarse<-as.numeric(((coarse_fine_data_yr1_all$ln_percent_afdm_start)-(coarse_fine_data_yr1_all$ln_percent_afdm_rem_C))/(0-coarse_fine_data_yr1_all$days_in_record))

coarse_fine_data_yr1_all$k_fine<-as.character(((coarse_fine_data_yr1_all$ln_percent_afdm_start)-(coarse_fine_data_yr1_all$ln_percent_afdm_rem_F))/(0-coarse_fine_data_yr1_all$days_in_record))

coarse_fine_data_yr1_all$k_fine<-as.numeric(((coarse_fine_data_yr1_all$ln_percent_afdm_start)-(coarse_fine_data_yr1_all$ln_percent_afdm_rem_F))/(0-coarse_fine_data_yr1_all$days_in_record))
...
3 October 2023 - filter out the k-values that would be interpreted as weight "gains". This also gets rid of "Inf" and "NA" values
```{r}

#first, check what you are removing with this filter:
gains_c <- coarse_fine_data_yr1_all %>% filter(k_coarse>0) #coarse "gains" = 1

gains_f <- coarse_fine_data_yr1_all %>% filter(k_fine>0) #fine "gains" = 0

#remove the one coarse gain

coarse_fine_data_yr1_all$k_coarse <- as.character(coarse_fine_data_yr1_all$k_coarse)
coarse_fine_data_yr1_all$k_coarse <- if_else(coarse_fine_data_yr1_all$k_coarse=="0.0238228361867918", NA, coarse_fine_data_yr1_all$k_coarse)
coarse_fine_data_yr1_all$k_coarse <- as.numeric(coarse_fine_data_yr1_all$k_coarse)
...
write.csv(coarse_fine_data_yr1_all, "litter_breakdown_coarse_fine_yr1_all.3Oct23.csv")
